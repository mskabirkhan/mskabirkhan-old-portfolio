...
<div class="nav-wrapper">
    <a href="#!" class="brand-logo"><img src="assets/images/name_logo_white.png"></a>
...
<div class="footer-left">
  <div class="footer-img">
    <img src="assets/images/name_logo_white.png" alt="User img" style="width:220px;">
  </div>
  <div class="footer-text">
    <p style="color:#cccccc">"Develop a passion for learning. If you do, you will never cease to grow."</p>
  </div>
  <div class="footer-icons">
    <a href="https://twitter.com/shahriarkabir73" class="twitter sub-footer-icon">
      <i class="fab fa-twitter"></i>
    </a>
    <a href="#" class="instagram sub-footer-icon">
      <i class="fab fa-instagram"></i>
    </a>
    <a href="www.linkedin.com/in/kabiruh19" class="linkedin sub-footer-icon">
      <i class="fab fa-linkedin"></i>
    </a>
    <a href="https://github.com/mskabirkhan" class="git sub-footer-icon">
    ...
    <a href="https://www.kaggle.com/shahria73" class="kaggle sub-footer-icon">
      <i class="fab fa-kaggle" id="kaggle-icon"></i>
    </a>
  </div>
  <div class="footer-email">
    <a href="s.kabir973@gmail.com" class="email-icon" style="color:#cccccc;">
